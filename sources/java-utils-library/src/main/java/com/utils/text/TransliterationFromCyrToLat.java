 ...
 */
public class TransliterationFromCyrToLat {
    ...
    public static void main(String[] args) {
        String s1 = cyrToLat("Александр Иванович Лебедь");
        String s2 = cyrToLat("Веснушчатый Щавелевый");
        String s3 = cyrToLat("Широкая электрификация южных губерний даст мощный толчок подъёму сельского хозяйства");
        String s4 = cyrToLat("Съешь же ещё этих мягких французских булок да выпей чаю.");
        String s5 = cyrToLat("А Б В Г Д Е Ё Ж З И Й К Л М Н О П Р С Т У Ф Х Ц Ч Ш Щ Ъ Ы Ь Э Ю Я");
        String s6 = cyrToLat("Tatiana Wilson");
        ...
        System.out.println();
        System.out.println(latToCyr(s1));
        System.out.println(latToCyr(s2));
        System.out.println(latToCyr(s3));
        System.out.println(latToCyr(s4));
        System.out.println(latToCyr(s5));
        System.out.println(latToCyr(s6));
    }
}
